...
import { LayoutDashboard, BookOpen, PanelLeftClose, PanelLeftOpen, Flame, Settings } from 'lucide-react'
...
export function Sidebar({ active, onSelect, onManageTypes }: SidebarProps) {
